...
<body>
                    ...
                    <table class="table table-responsive-md">
                        ...
                        <tbody>
                            <tr class="an-trow">
                                ...
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12200");
                                    if (check1) {
                            ...
                            <tr class="an-trow">
                                ...
                                <td>[2.38] Archon Network Any</td>
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12300");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
                            ...
                            <tr class="an-trow">
                                ...
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12014");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
                    ...
                    <table class="table table-responsive-md">
                        ...
                        <tbody>
                            <tr class="an-trow">
                                ...
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12001");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
                            ...
                            <tr class="an-trow">
                                ...
                                <td>[2.37] Archon Network Any</td>
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12002");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
                    ...
                    <table class="table table-responsive-md">
                        ...
                        <tbody>
                            <tr class="an-trow">
                                ...
                                <td>[2.38] JDPS</td>
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12006");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
                            ...
                            <tr class="an-trow">
                                ...
                                <td>[2.38] WISD</td>
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12400");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
                            ...
                            <tr class="an-trow">
                                ...
                                <td>[2.38] NCPS</td>
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12011");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
                            ...
                            <tr class="an-trow">
                                ...
                                <td>[2.38] GHCS</td>
                                <td>
                                    <?php $check1 = fsockopen("archonetwork.net", "12007");
                                    if (check1) {
                                        echo ("<span class='online'>".Online."</span>");
                                        $close = fclose($check1);
                                    }
    ...
    <footer class="footer-basic">
        <div class="social"><a href="https://www.youtube.com/channel/UC33B7tlCJftRLNcG7ZgNCNw"><i class="fa fa-youtube-play" style="color:#bb0000;"></i></a><a href="https://twitter.com/Archonetwork" target="_blank"><i class="fa fa-twitter" style="color:#00aced;"></i></a>
            <a
            href="https://discord.gg/j2KzKBF" target="_blank"><img src="../assets/img/Discord-Logo-Color.svg" height="25px"></a>
        </div>
        <ul class="list-inline">
            ...
            <li class="list-inline-item"><a href="https://discord.gg/j2KzKBF" target="_blank">Discord </a></li>
        </ul>
        <p class="copyright">Archon Network © 2017</p>
    </footer>
